...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '3feng of FutureMedia.Work', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '疯人院里的傻子🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://futuremedia.work', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,三疯,未来,新媒体,AI,人工智能,大语言模型,预言', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'service@futuremedia.work', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/twchairman', // 你的twitter个人主页
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://futuremedia.notion.site', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
